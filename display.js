window.addEventListener('load', function() {
    setTimeout(function() {
      ...
      document.getElementById('MainContainer').style.display = 'flex'; //bug fix update 
...
/*
function formobile(){
  var stations = new Map(); //station OuterMap

  //create each stations
  var kowdiar = new Map(); //innermap
  kowdiar
    .set("0018","11:10","11:12","EARLY","R1")//buses
    .set("00019","11:11","11:21","EARLY","R2")
    .set("0020","11:10","11:12","EARLY","R1")//buses
    .set("0021","11:10","11:12","EARLY","R1")//buses
    .set("0022","11:10","11:12","EARLY","R1");//buses
}

stations.set("kowdiar",kowdiar);
console.log(outerMap.get("innerMap1").get("key1"));
*/
...
var stations = {
  ...
  stationKeys_length = stationKeys.length;
  var counter = 0;
